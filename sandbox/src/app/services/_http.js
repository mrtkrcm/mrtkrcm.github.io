...
export default {
  ...
  // get: async (url, params, headers = { Authorization: `Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1aWQiOiJiMT
  // RkMTQ0My04ZGVkLWU0MTEtYjRjNy0wMDE1NWRjY2QzMTMiLCJ0cyI6MTU1NTE2MTIwNTgxN30.6U3FXzMDXbaqQ79aWYVMYc2AfXdJnW_r7w
  // I4DG0fuyg` }) => api.get(url, params, { headers }),
